  ...
  switch (r) {
    ...
    case 10:
      return (function __PRIVATE_compareVectors(t2, e2) {
        const r2 = t2.fields || {}, n2 = e2.fields || {}, i = r2[et]?.arrayValue, s = n2[et]?.arrayValue, o = __PRIVATE_primitiveComparator(i?.values?.length || 0, s?.values?.length || 0);
        if (0 !== o) return o;
        return __PRIVATE_compareArrays(i, s);
      })(t.mapValue, e.mapValue);
    case 11:
      return (function __PRIVATE_compareMaps(t2, e2) {
        if (t2 === X && e2 === X) return 0;
        if (t2 === X) return 1;
        if (e2 === X) return -1;
...
function __PRIVATE_extractDocumentKeysFromArrayValue(t, e) {
  return (e.arrayValue?.values || []).map(((t2) => DocumentKey.fromName(t2.referenceValue)));
}
...
var __PRIVATE_ExponentialBackoff = class {
  constructor(t, e, r = 1e3, n = 1.5, i = 6e4) {
    this.U = t, this.timerId = e, this.j = r, this.W = n, this.K = i, this.G = 0, this.J = null, /** The last backoff attempt, as epoch milliseconds. */
  ...
  Z(t) {
    ...
    n > 0 && __PRIVATE_logDebug("ExponentialBackoff", `Backing off for ${n} ms (base delay: ${this.G} ms, delay with jitter: ${e} ms, last attempt: ${r} ms ago)`), this.J = this.U.enqueueAfterDelay(this.timerId, n, (() => (this.H = Date.now(), t()))), // Apply backoff factor to determine next delay and ensure it is within
    // bounds.
...
async function __PRIVATE_invokeRunAggregationQueryRpc(t, e, r) {
  const n = __PRIVATE_debugCast(t), { request: i, nt: s, parent: o } = (function __PRIVATE_toRunAggregationQueryRequest(t2, e2, r2, n2) {
  ...
  })(n.serializer, (function __PRIVATE_queryToAggregateTarget(t2) {
  ...
  return Object.keys(u).reduce(((t2, e2) => (t2[s[e2]] = u[e2], t2)), {});
}
...
var __PRIVATE_ArrayUnionFieldValueImpl = class ___PRIVATE_ArrayUnionFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(t) {
    const e = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.Pt.map(((t2) => __PRIVATE_parseData(t2, e))), n = new __PRIVATE_ArrayUnionTransformOperation(r);
    return new FieldTransform(t.path, n);
  }
  isEqual(t) {
    return t instanceof ___PRIVATE_ArrayUnionFieldValueImpl && deepEqual(this.Pt, t.Pt);
  }
};
var __PRIVATE_ArrayRemoveFieldValueImpl = class ___PRIVATE_ArrayRemoveFieldValueImpl extends FieldValue {
  ...
  _toFieldTransform(t) {
    const e = __PRIVATE_createSentinelChildContext(
      ...
      /*array=*/
      true
    ), r = this.Pt.map(((t2) => __PRIVATE_parseData(t2, e))), n = new __PRIVATE_ArrayRemoveTransformOperation(r);
    return new FieldTransform(t.path, n);
  }
  isEqual(t) {
    return t instanceof ___PRIVATE_ArrayRemoveFieldValueImpl && deepEqual(this.Pt, t.Pt);
  }
};
var __PRIVATE_NumericIncrementFieldValueImpl = class ___PRIVATE_NumericIncrementFieldValueImpl extends FieldValue {
  ...
  isEqual(t) {
    return t instanceof ___PRIVATE_NumericIncrementFieldValueImpl && this.At === t.At;
  }
};
...
var __PRIVATE_TransactionRunner = class {
  constructor(t, e, r, n, i) {
    this.asyncQueue = t, this.datastore = e, this.options = r, this.updateFunction = n, this.deferred = i, this.Vt = r.maxAttempts, this.It = new __PRIVATE_ExponentialBackoff(
      this.asyncQueue,
      "transaction_retry"
  ...
  Ft(t) {
    this.Vt > 0 && this.vt(t) ? (this.Vt -= 1, this.asyncQueue.enqueueAndForget((() => (this.gt(), Promise.resolve())))) : this.deferred.reject(t);
  }
  vt(t) {
...
var __PRIVATE_AsyncQueueImpl = class {
  constructor(t = Promise.resolve()) {
    ...
    this.Ct = null, // Flag set while there's an outstanding AsyncQueue operation, used for
    ...
    this.It = new __PRIVATE_ExponentialBackoff(
      this,
      "async_queue_retry"
    ...
    this.Bt = () => {
      ...
      t2 && __PRIVATE_logDebug(ft, "Visibility state changed to " + t2.visibilityState), this.It.tt();
    }, this.$t = t;
    const e = getDocument();
  ...
  enqueue(t) {
    ...
    return this.kt((() => this.bt && this.Ot ? Promise.resolve() : (t().then(e.resolve, e.reject), e.promise))).then((() => e.promise));
  }
  enqueueRetryable(t) {
  ...
  zt(t) {
    return this.Ut().then((() => {
      ...
      for (const e of this.St) if (e.skipDelay(), "all" !== t && e.timerId === t) break;
      return this.Ut();
    }));
  }
  /**
